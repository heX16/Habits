...
class SimpleTableApp(App):
    ...
    def build(self):
        ...
        button2 = Button(text="Delete Row New", size_hint_x=0.2, on_press=self.on_delete_row_new)
        ...
        button6 = Button(text="+1 cols", size_hint_x=0.25, on_press=self.on_add_col)
